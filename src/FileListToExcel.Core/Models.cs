...
public sealed record ScanRequest(IReadOnlyList<string> Paths, ScanMode Mode, bool SkipAllReparsePoints = false);
...
public sealed record ScanProgress(long ItemCount, long ErrorCount, string CurrentPath, DuplicateProgress? Duplicate = null);
